...
const BUILT_IN = {
  ...
  cswap: {
    ...
    header: '#e8e4de', dim: '#6a6a6a', accent: '#d7875f', border: '#3a3a3a',
  },
  ...
  'cswap-light': {
    ...
    header: '#2b2723', dim: '#7d766c', accent: '#954c2a', border: '#cec7ba',
  },
