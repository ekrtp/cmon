...
//      a PATH ("billing-api/src", "docs-site\\content") counts far more
...
function candidatesFor(cwd) {
  ...
  // router file is allowed to lag: a folder it does not mention (measured: one
  // deliberately untracked personal folder) is still a real place to be working.
